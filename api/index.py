...
# Dictionary of all your model/vectorizer files and their corresponding Google Drive file IDs
files_to_download = {
    "rf_classifier_categorization.pkl": "1Bq2IEdhVDFdoNINZtpoRuGdHgO2F60Op",
    "tfidf_vectorizer_categorization.pkl": "1pG9QMP7A211oI9-pUai4yUktKy7ZqKiH",
    "rf_classifier_job_recommendation.pkl": "14tfJN9xfC-atXnphBP94CUYidJ2Ymipn",
    "tfidf_vectorizer_job_recommendation.pkl": "1AykgInB8x00OBkBtt5e8WJU810wexyom",
}
...
def pred():
    ...
    if 'resume' in request.files:
        ...
        return render_template('result.html', predicted_category=predicted_category,recommended_job=recommended_job,
